...
describe('Synapse', () => {
    ...
    describe('Session Keys', () => {
        ...
        it('should create dataset with session key', async () => {
            ...
            }), ...Mocks.pdp.streamingUploadHandlers(), Mocks.pdp.findAnyPieceHandler(true), Mocks.pdp.dataSetCreationStatusHandler(FAKE_TX_HASH, {
        ...
        it('should schedule deletion with session key', async () => {
            ...
            }), http.delete(`https://pdp.example.com/pdp/data-sets/:id/pieces/:pieceId`, async ({ request }) => {
                const body = (await request.json());
...
//# sourceMappingURL=session-keys.test.js.map