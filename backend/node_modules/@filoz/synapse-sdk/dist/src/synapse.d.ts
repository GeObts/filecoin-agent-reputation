...
import { type Account, type Address, type Client, type PublicActions, type PublicRpcSchema, type Transport } from 'viem';
...
export declare class Synapse {
    ...
    private readonly _filbeamService;
    private readonly _providers;
    private readonly _client;
    private readonly _sessionClient;
    private readonly _chain;
    static create(options: SynapseOptions): Synapse;
    constructor(options: SynapseFromClientOptions);
