...
import { LOCKUP_PERIOD } from "../utils/constants.js";
export async function setOperatorApproval(client, options) {
...
export async function setOperatorApprovalSync(client, options) {
...
export function setOperatorApprovalCall(options) {
...
export function extractSetOperatorApprovalEvent(logs) {
    ...
    if (!log)
        throw new Error('`OperatorApprovalUpdated` event not found.');
    return log;
}
//# sourceMappingURL=set-operator-approval.js.map