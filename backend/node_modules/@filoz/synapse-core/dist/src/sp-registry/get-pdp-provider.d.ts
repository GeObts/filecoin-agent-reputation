...
export declare namespace getPDPProviderByAddress {
    type OptionsType = {
        address: Address;
        contractAddress?: Address;
    };
    type OutputType = PDPProvider | null;
    type ErrorType = getProviderIdByAddress.ErrorType | getPDPProvider.ErrorType;
}
export declare function getPDPProviderByAddress(client: Client<Transport, Chain>, options: getPDPProviderByAddress.OptionsType): Promise<getPDPProviderByAddress.OutputType>;
