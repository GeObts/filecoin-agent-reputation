...
import { AddPiecesError, CreateDataSetError, DeletePieceError, FindPieceError, InvalidUploadSizeError, LocationHeaderError, PostPieceError, UploadPieceError, } from "../errors/pdp.js";
import { PullError } from "../errors/pull.js";
import * as Piece from "../piece/piece.js";
...
export async function pullPieces(options) {
    ...
    return (await response.result.json());
}
export async function waitForPullStatus(options) {
    const url = new URL('pdp/piece/pull', options.serviceURL);
    const body = buildPullRequestBody(options);
    const headers = { 'Content-Type': 'application/json' };
    const fetchWithFreshRequest = (input, init) => {
