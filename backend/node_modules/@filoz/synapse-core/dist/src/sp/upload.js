...
import { DataSetNotFoundError } from "../errors/warm-storage.js";
...
import { getPdpDataSet } from "../warm-storage/get-pdp-data-set.js";
import * as SP from "./sp.js";
export async function upload(client, options) {
    ...
    const uploadResponses = await Promise.all(options.data.map(async (file) => {
